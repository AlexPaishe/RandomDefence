...
public class EnemyFlyMove : MonoCache
{
    ...
    private Vector3 _eggtarget = new Vector3(999, 999, 999);
    ...
    public override void OnFixedTick()
    {
        if (_health.Health > 0)
        {
            ...
            if (_trans.position == _target && _target == _pointsWay[1] ||_trans.position == _target && _target != _eggtarget && _target != _pointsWay[0] && _target != _pointsWay[1])
            {
                _health.Health = 0;
            }
