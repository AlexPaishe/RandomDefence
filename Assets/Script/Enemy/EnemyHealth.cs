...
public class EnemyHealth : MonoCache
{
    ...
    [SerializeField] private EnemySound _eSound;
    ...
    public float Health
    {
        ...
        set
        {
            ...
            if(_health <=0)
            {
                ...
                _money.GiveMoney();
                _bigMoney.infoState[1]++;
                _bigMoney.infoState[3]++;
                _eSound.Death();
            }
    ...
    /// <summary>
    /// Увеличение хп с волной
    /// </summary>
    /// <param name="var"></param>
    public void UpgradeHealthMax(float var)
    {
        _healthMax *= var;
    }
}
